...
export async function Footer() {
    ...
    return (
        <footer className="w-full bg-black text-white py-6 md:py-16" data-cursor="invert">
            <div className="container mx-auto px-4 md:px-6">
                <div className="space-y-5 md:space-y-8">

                    {/* Navigation Links */}
                    <div className="flex flex-wrap justify-center md:justify-start gap-3 md:gap-6 text-sm md:text-base">
                            ...
                            return (
                                ...
                                >
                                    {social.icon_key === 'twitter' || social.icon_key === 'x' ? (
                                        // X Logo
                                        <svg viewBox="0 0 24 24" aria-hidden="true" className="w-5 h-5 md:w-5 md:h-5 fill-current">
                    ...
                    {/* Copyright */}
                    <div className="pt-5 md:pt-8 border-t border-gray-800 text-center">
